		...
		public function breadcrumb_html($themes)
			{
				...
				if(is_front_page() && is_home())
					{
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="#">'.__('Главная','breadcrumb').'</a><span>'.$breadcrumb_separator.'</span></li>';	
							}
				...
				elseif( is_home())
				...
				else if(is_attachment())
					{
						...
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="'.get_bloginfo('url').'">'.__('Главная','breadcrumb').'</a></li>';
							}
...
//echo '<pre>'.var_export($parent_cat_links,true).'</pre>';
				...
				else if(is_tag())
					{
						...
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="'.get_bloginfo('url').'">'.__('Главная','breadcrumb').'</a><span class="separator">'.$breadcrumb_separator.'</span></li>';
							}
